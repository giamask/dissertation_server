...
class TestController extends ResourceController {
  ...
  Future<Response> getAssetRegistry(@Bind.query('body') String body) async {
    ...
    await obtainAccessCredentialsViaServiceAccount(_credentials, ["https://www.googleapis.com/auth/firebase.messaging"], client)
     ...
     http.Response resp = await http.post("https://fcm.googleapis.com/v1/projects/map-testing-547d4/messages:send",
      headers: {"Content-Type":"application/json","Authorization":"Bearer " + credentials.accessToken.data},
      body: message);
      print(resp.body);
      client.close();
    });
